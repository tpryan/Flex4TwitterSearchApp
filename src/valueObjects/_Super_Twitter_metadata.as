...
public class _Super_Twitter_metadata extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {    	
    	...
    	if (value == null || _internal_twitter_result_type == null)
    	{
    		recalcValid = true;
    	}	
   ...
   model_internal function setterListenerAnyConstraint(value:flash.events.Event):void
   {
    ...
    model_internal function calculateIsValid():Boolean
    {
		...
		{
			violatedConsts.push("twitter_result_typeIsRequired");
			validationFailureMessages.push("twitter_result_type is required");
		}
